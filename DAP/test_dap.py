...
def test_dap():
    ...
    # Paths
    weights_path = Path(__file__).parent.parent / "checkpoints" / "dap" / "model.pth"
    image_path = Path(__file__).parent.parent / "data" / "input.jpg"
    output_path = Path(__file__).parent.parent / "data" / "input_depth.png"
    output_npy_path = Path(__file__).parent.parent / "data" / "input_depth.npy"
